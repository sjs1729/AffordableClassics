...
html_text = '<BR><div style="font-family: Arial, sans-serif; font-size: 1.1em; line-height: 1.5;color:#941751"> \
  ...
  Our bespoke creations, complete with optional hand-embroidered initials, bring comfort, style, and personal flair right to your doorstep. \
...
c2.image("Shirt_White.png", width=200)  # Adjust width as needed
